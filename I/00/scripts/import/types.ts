export const SNAPSHOT_PERIOD_START = "2026-08-31";
export const SNAPSHOT_PERIOD_END = "2026-09-06";
...
export interface SnapshotMetadata { snapshotId: string; source: string; provider: string; dataset: string; dataType: "OFFICIAL_SCHEDULED_TIMETABLE_SNAPSHOT"; retrievedAt: string; periodStart: string; periodEnd: string; timezone: string; license: string; attribution: string; normalizationVersion: string; }

...
describe("frozen official TDX golden journey", () => {
  it("runs exact-date planning and delay replanning without credentials or live TDX", () => {
    ...
    try {
      ...
      expect(proof.replan).toMatchObject({ nodeId: "1060", currentAt: "2026-08-31T11:49:00+08:00", status: "FEASIBLE", goalDeadline: "2026-08-31T17:00:00+08:00", safetyMarginMinutes: 195, reasonCodes: ["MEETS_DEADLINE_WITH_BUFFER"] });
      ...
      expect(proof.replan.replacementServices).toEqual([{ serviceId: "THSR_0636_20260831:1060-1020", serviceRunId: "THSR_0636_20260831", trainNo: "0636", fromNodeId: "1060", toNodeId: "1020", departureAt: "2026-08-31T12:13:00+08:00", arrivalAt: "2026-08-31T13:36:00+08:00" }]);

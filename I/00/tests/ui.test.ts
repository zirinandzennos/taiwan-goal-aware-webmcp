...
describe("official browser journey execution path", () => {
  ...
  it("replans from Tainan identically and discovers 0636 after departed 1634", async () => {
    ...
    expect(human).toMatchObject({ kind: "REPLAN_RESULT", replan: {
      ...
      plan: { balanced: { candidate: { id: agent.plan.balanced.candidateId, legs: [{ serviceId: "THSR_0636_20260831:1060-1020" }] } } },
    } });
    expect(agent).toMatchObject({
      status: "FEASIBLE",
      safetyMarginMinutes: 195,
      recommendedJourney: { legs: [{ serviceId: "THSR_0636_20260831:1060-1020" }] },
    });

export const SNAPSHOT_PERIOD_START = "2026-08-24T00:00:00+08:00";
export const SNAPSHOT_PERIOD_END = "2026-08-30T23:59:59+08:00";
...
export interface TdxStopTime { StopSequence: number; StationID: string; StationName?: TdxLocalizedName; ArrivalTime: string; DepartureTime: string; }
export interface TdxDailyTimetableRecord { TrainDate: string; DailyTrainInfo: { TrainNo: string }; StopTimes: TdxStopTime[]; }
